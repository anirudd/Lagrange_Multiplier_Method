...
This project implements Lagrange Mutiplier method for solving a general non-linear optimisation problem in Matlab.  The code developed also verifies the solution of the non-linear programming problem, by employing the Hessian Matrix method.
